  ...
  return (
    <div className="wrapper">
      <Helmet bodyAttributes={{ class: "body body--no-scroll" }}>
        ...
        <meta
          name="description"
          content="Front-end web developer or something- clw8's web portfolio. "
        ></meta>
        <link
      ...
      <Header
        onMouseEnter={createTyped}
        onMouseOut={onLinkMouseOut}
        show={showPageFirstLoad}
      />

      <ToastProvider>{showPageFirstLoad && childrenWithProps}</ToastProvider>

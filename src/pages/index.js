          ...
          <Fade bottom distance={"20px"} duration={2000} delay={1600}>
            <div className="content__above-fold">
              <div className="content__section content__section--border">
                ...
                <p>
                  I approach problem-solving with as much patience as possible!
                  While it's always great to instantly find the fix for a bug
                  via Stack Overflow, there are times when that approach doesn't
                  cut it.{" "}
                </p>
                <p>
                  It's during those times, I've found that patience with myself
                  and others really is a virtue. And after much (oddly calm)
                  head scratching, I'll usually find the solution to the problem
                  with dogged persistence and perhaps some creative ingenuity.
                </p>
                <p>
                  When I work on a project, I'll also try first to understand
                  the bigger picture, and how the nitty-gritty details all fit
                  in; not only to provide a great UI/UX but also to holistically
                  provide value to the business' product offering and keep
                ...
                <p>
                  ...
                  contacted you or applied to your company, I'd love to talk
                  with you over a (remote?) cup of coffee.
                </p>
              </div>
          ...
          <Fade bottom cascade distance={"20px"} duration={2000}>
            <article className="content__section" id="contact">
              ...
              <div className="icon-container__flex">
                ...
                <a
                  className="icon-flex"
                  href="https://www.linkedin.com/in/christopher-walsh-1a2446132/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
                ...
                {/* Codepen icon */}
                <a
                  className="icon-flex icon-flex__codepen"
                  href="https://codepen.io/clw8"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg

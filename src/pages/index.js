          ...
          <div className="content">
                ...
                <div className="project-card__container">
                  {projectData.map((datum, index) => (
                    <ProjectCard datum={datum} 
                                 key={index}
                                 onClick={() => onProjectCardClick(datum, index)}></ProjectCard>
                  ))}
                </div>
              </div>
            ...
            <Fade bottom cascade distance={"20px"} duration={2000} when={show}>
              ...
              <div className="content__section" id="contact">
                ...
                <p>And get in contact with me <a href="mailto:mail@clw8.com">here</a>.</p>
                <br></br>
                <div className="icon-container__flex">
                  {/* Github icon */}
                  <a className="icon-flex" href="https://github.com/clw8" target="_blank">
                    ...
                    {/* Linkedin icon */}
                  <a className="icon-flex" href="https://www.linkedin.com/in/christopher-walsh-1a2446132/" target="_blank">
                  ...
                  {/* Codepen icon */}
                  <a className="icon-flex icon-flex__codepen" href="https://codepen.io/clw8" target="_blank">
                    <svg enable-background="new 0 0 128 128"  version="1.1" viewBox="0 0 128 128" width="1.45rem" height="1.45rem">
